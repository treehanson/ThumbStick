			...
			<div role="main">
				...
				// Loop through each movie and add poster to Now Showing section
					foreach ($ns_movies as $key => $value) {
						...
						$ns .= "<div class='whiteButton round center'><a href=\"../trailer.php?title=" . htmlentities(getName($value['name']), ENT_QUOTES) . "&p=$key&m=$key&t=1&iframe=true&width=600&height=400\" class='various redUpperSml'  data-fancybox-type='iframe'>Trailer</a></div>";
