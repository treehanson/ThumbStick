...
require_once '../db/db_conn.php';
	...
	foreach ($houses as $house) {
		...
		$nameReplace = str_replace("(Coming Soon)", "</h1><span style='font-size:0.7em;'>(Coming Soon)</span>", $name);
		...
		if ($count === 1) {
			$col1 .= "
				<div class='full-box location round'>
					<a href='theatre.php?house_id=$house_id'>
					...
					$guestServices
					$screens
					<a href='../locations/theatre.php?house_id=$house_id'>View Showtimes</a>
			...
			$col3 .= "
				<div class='full-box location round'>
					<a href='../locations/theatre.php?house_id=$house_id'>
						<img src='../img/theaters/$house_id.jpg' alt='$name' />
						<h1>$nameReplace</h1>
					</a>
					<p>$address</p>
					...
					$guestServices
					$screens
					<a href='theatre.php?house_id=$house_id'>View Showtimes</a>
					<a href='$g_address' target='_blank'>Map &amp; Directions</a>
				</div>
			";
			$count = 0;
