...
namespace Dreamland
{
    public partial class dreamland : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (rsData.HasRows)
                {
                    ...
                    {
                        lblTitleMovie.Text = rsData["name"].ToString() + "(" + rsData["mpaa"].ToString().Trim() + ")";
        ...
        protected void Showdates()
        {
            ...
            //xs = null;
            //populate the jquery menu
            rptDates.DataSource = aryDates;
            rptDates.DataBind();
        }
        ...
        {
            currentdate.Attributes["class"] = "currentdate";
            day1.Attributes["class"] = "date";
            day2.Attributes["class"] = "date";
            lblShowdate.Text = ShowDateToday.ToString();
            lblDate.Text = ShowDateToday.ToString("dddd, M/d");
        ...
        {
            currentdate.Attributes["class"] = "date";
            day1.Attributes["class"] = "currentdate";
            day2.Attributes["class"] = "date";
        ...
        protected void changeDate2(object sender, EventArgs e) 
        {
            currentdate.Attributes["class"] = "date";
            day1.Attributes["class"] = "date";
            day2.Attributes["class"] = "currentdate";
        ...
        protected void bringFront()
        {
            ...
            if (rsData.HasRows)
            {
                ...
                lblMovieTimes.Text = csmovies.AppendTimes(rsData, lblShowdate.Text, "", "", "", "", false);
                lblMovieTimes.Text = Regex.Replace(lblMovieTimes.Text, @"<(.|\n)*?>", "");
                lblMovieTimes.Text = Regex.Replace(lblMovieTimes.Text, "[(]", "");
                lblMovieTimes.Text = Regex.Replace(lblMovieTimes.Text, "[)]", "am");
                lblMovieTimes.Text = Regex.Replace(lblMovieTimes.Text, ",", ", ");
