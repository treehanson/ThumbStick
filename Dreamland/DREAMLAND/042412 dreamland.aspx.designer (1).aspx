...
<body>
    ...
    <asp:Label ID="lblTest" runat="server" Visible="true" Text="Label"></asp:Label>
    ...
    <div class="background">
        <div class="header">
            ...
            <div class="main">
                ...
                <script type="text/javascript">
                jwplayer("mediaspace").setup({ autostart: true, file: 'http://media.westworldmedia.com/mp4/' + document.getElementById("hdnMovieFld").value + '_high.mp4', flashplayer: "jwplayer59/player.swf", width: 457, height: 304 });
                </script>
                </asp:Panel>
                </div>
